...
def analyze_transaction_dna(transactions, start_wallet):
    ...
    if native_values and average_native_transfer > 5:
        indicators.append(
    ...
    return {
        ...
        "native_transaction_count": native_transaction_count,
        "token_transaction_count": token_transaction_count,
        "native_volume": native_volume,
        "token_volume": token_volume,
        "average_native_transfer": average_native_transfer,
        "average_transfer": average_native_transfer,
        "total_volume": native_volume,
